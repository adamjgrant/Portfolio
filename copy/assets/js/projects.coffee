...
Paths should prefix with these category names to get from partial dirs.
###
...
window.projects = [
	...
	year: 1998
	employer: false
	shortDesc: '[Make sure date is before wikipedia] An online encylclopedia anyone can edit. Sound familiar? I had the idea way before the other guys, but trust me--it was much worse.'
